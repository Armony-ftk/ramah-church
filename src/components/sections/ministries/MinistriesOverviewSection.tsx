...
export default function MinistriesOverviewSection() {
  const { overview } = ministriesPageContent;

  return (
    <section
      aria-labelledby="ministries-overview-title"
